...
> = {
  ...
  truss: {
    ...
    formulas: [{
      ...
      latex: String.raw`N=EA\left(\frac{u_j^l-u_i^l}{L}-\alpha\Delta T-\varepsilon_0\right)`,
    }],
  ...
  frame: {
    title: '平面刚架理论',
    formulas: [{
      id: 'P2-FRAME-001', label: '局部—全局刚度变换', version: 'P2-FRAME-v1',
      latex: String.raw`\boldsymbol{k}_g=\boldsymbol{T}^{\mathsf T}\boldsymbol{k}_l\boldsymbol{T}`,
    }],
