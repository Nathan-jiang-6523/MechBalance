...
describe('torsion UI adapters', () => {
  it('normalizes default engineering shaft units to SI', () => {
    expect(buildCircularShaftInput(createDefaultCircularShaftDraft())).toEqual({
      kind: 'solid', diameterM: 0.05, lengthM: 1, shearModulusPa: 80e9, torqueNm: 1000,
    })
  })

  it('produces identical results across engineering and SI-friendly units', () => {
    ...
    alternate.shearModulus = { value: '80', unit: 'GPa' }
